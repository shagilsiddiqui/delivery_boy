                    ...
                    child: Container(
                      child: Column(
                        ...
                        Row(
                          ...
                          SizedBox(height: 20),
                          Text('working Per Hour',style: TextStyle(color: Colors.black,fontSize: 15),),
                          SizedBox(
                            height: 10,
                          ),
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: Theme.of(context).focusColor.withOpacity(0.2), style: BorderStyle.solid,),
                            ),
                          ...
                          Text('I own a',style: TextStyle(color: Colors.black,fontSize: 15),),
                          SizedBox(
                            height: 10,
                          ),
                          Container(
                          ...
                          Text('work on',style: TextStyle(color: Colors.black,fontSize: 15),),
                          SizedBox(
                            height: 10,
                          ),
                          Container(
